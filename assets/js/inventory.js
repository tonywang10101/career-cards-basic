...
const INVENTORY_CARDS = [
  { id:1, category:"Action & Execution", title:"追求品質",
    ...
    shadow1:"過度專注局部，延誤整時效", shadow2:"標準過高，對他人過度挑惕，合作氣氛緊繃",
  ...
  { id:2, category:"Action & Execution", title:"目標導向",
    descLines:["鎖定目標、聚焦最終成果", "每週檢視進度，必要時主動調整路線", "以成果為核心，排除非必要流程", "遇到趕擾時會回到目標檢核：這件事有幫助嗎？"],
    shadow1:"為達到目標不擇手段", shadow2:"只在乎結果，忽略人的感受",
    consequence1:"忽視秩序、破壞信任", adjustment1:"堅守正值，在規範內行事",
  ...
  { id:3, category:"Action & Execution", title:"提升效率",
    descLines:["總能找到最快路徑，省時省力", "厭惡冗余流程，主動尋求簡化", "會把重複工作變模板或自動化", "以更少投入，創造更多產出"],
    ...
    fitRole:"流程改善、生感管理、營運", fitTask:"導入新系統、優化工作流", fitGeneral:"擴大範圍協助提升團隊效率",
  ...
  { id:6, category:"Action & Execution", title:"廣泛收集",
    ...
    shadow1:"缺查篩選，收集很多但用不到、無法斷捨離", shadow2:"只有輸入沒有輸出",
    consequence1:"抓不到重點，浪費時間", adjustment1:"先帝應問題，再精準搜集",
  ...
  { id:8, category:"Action & Execution", title:"資源應用",
    ...
    shadow1:"過地依賴人脈，忽視自身實力", shadow2:"借力不顧品質，外包難以控管",
  ...
  { id:9, category:"Action & Execution", title:"靈活應變",
    ...
    consequence2:"留下許多管理寨貨營運債", adjustment2:"事後保留完整時間解決問題",
  ...
  { id:10, category:"Action & Execution", title:"統籌規劃",
    descLines:["化繁為簡，拆解複雜任務", "考量變數、找到資源配置的最佳最法", "擅長安排時程、資源與分工", "制定行動藍圖，設定里程碑與交付物"],
    ...
    fitRole:"專案經理、活動策劃、幕僚", fitTask:"大型專案導入、年度計劃、活動籌辦", fitGeneral:"共用甘特圖或儀表板，讓複雜任務視覺話，對其所有人認知",
  ...
  { id:11, category:"Action & Execution", title:"持續優化",
    ...
    improveSteps:["1. 建議個人改善日誌，紀錄優化", "2. 訪問使用者（內/外部），尋找痛點"] },
  ...
  { id:17, category:"Action & Execution", title:"時間管理",
    ...
    consequence1:"關係疏離", adjustment1:"將溝通與關懷是為必要的時間投資",
  ...
  { id:18, category:"Action & Execution", title:"成就導向",
    descLines:["創造獨特或重大的成果", "想受成就達成的滿足感", "需要用客觀表準衡量進步", "閒不下來，自我驅動無需外在鞭策"],
  ...
  { id:21, category:"Thinking & Mindset", title:"邏輯推理",
    descLines:["擅長歸納演繹，便是因果關係與模式", "能區分前提、證據、結論", "具備數據思維，能從中解讀意義", "能指出推論中的漏洞與偏誤"],
  ...
  { id:23, category:"Thinking & Mindset", title:"系統思考",
    descLines:["看見全貌，而非單一片段", "把問題放在整理流程與關係網中看", "預見牽一髮動全身的連鎖反應", "不會本位主義，追求整體最優"],
    shadow1:"想得太複雜而動不小", shadow2:"難以接受簡單姐，總想大改",
    consequence1:"不表達或措施行動時機", adjustment1:"在全面與速度間找尋平衡",
  ...
  { id:25, category:"Thinking & Mindset", title:"自律節制",
    descLines:["不需要他人監督", "在面對人際衝突或客戶抱怨時保持專業，不說出不洽當的內容", "能管理自身情緒，在高壓下穩定", "控制衝動、抵抗誘惑、節制慾望"],
  ...
  { id:26, category:"Thinking & Mindset", title:"相信自己",
    ...
    consequence2:"準備不周導致失敗", adjustment2:"考率反方觀點、建立風險清單",
  ...
  { id:33, category:"Thinking & Mindset", title:"發揮優勢",
    ...
    consequence1:"短版成為致命傷拖垮優勢", adjustment1:"設定短版最低表準與外部支援時間點",
  ...
  { id:34, category:"Thinking & Mindset", title:"樂觀正向",
    ...
    fitRole:"業務、客服、團隊領導者、公關", fitTask:"高壓環境、變革推動、激勵士氣", fitGeneral:"用勝利日誌與小慶祝創造正人氛圍",
  ...
  { id:35, category:"Thinking & Mindset", title:"獨立思考",
    ...
    fitRole:"顧問、策略、研發、法尊、內稽", fitTask:"決策會議、風險評估、創意發想", fitGeneral:"提出另一種觀點",
  ...
  { id:38, category:"People & Leadership", title:"社交敏銳",
    descLines:["擅長閱讀空寂，懂得調整語氣、場合與出手時機", "能精準便是利害關係人的意圖、角色、動機與顧慮", "覺察組織中檯面下的權力動態", "能快速看懂關係網與「誰影響誰」"],
    shadow1:"過度事故導致失去信任", shadow2:"陷入他人眼光，決策搖擺、不敢表達真實觀點",
    consequence1:"失去信任", adjustment1:"改為利益透明與立場清楚，說清楚彼此需要",
    consequence2:"因為從眾而判斷錯誤", adjustment2:"回到商業價值面判斷、或反思是否自己真心想要",
    fitRole:"公關、業務、幕僚、管理職", fitTask:"談判協商、利害關係人管理、跨部門專案協調、重大提案拜會", fitGeneral:"建立利害關係人替圖與影響策略",
    improveSteps:["1. 分析組織圖，誰跟誰連結", "2. 每次開會前寫「三問一底線」：對方要什麼、擔心什麼、能給什麼與我的底線"] },
  { id:39, category:"People & Leadership", title:"感同身受",
    descLines:["敏銳察覺他人情緒與潛在需求", "傾聽並理解他人為說出的觀點", "感知團隊氣氛，扮演關係潤滑劑", "主動給予關懷，建立心理安全感"],
  ...
  { id:40, category:"People & Leadership", title:"協調衝突",
    ...
    improveSteps:["1. 學習非暴力溝通（NVC）", "2. 扮演會議主持人ㄝ學會找需求交集"] },
  { id:41, category:"People & Leadership", title:"客戶導向",
    ...
    consequence1:"承諾無法兌現喊而傷害信譽", adjustment1:"清楚定義服務範圍",
  ...
  { id:50, category:"People & Leadership", title:"表達技巧",
    ...
    fitRole:"講師、公關、行銷、作家、主持人", fitTask:"簡報提案、公開演說、文案撰寫", fitGeneral:"成為團隊發言人，對其內外資訊",
  ...
  { id:54, category:"Skills & Application", title:"動手實作",
    ...
    consequence1:"與團隊脫節，成品不符需求", adjustment1:"實作前先對其規格",
  ...
  { id:55, category:"Skills & Application", title:"科技應用",
    ...
    fitRole:"資訊、數位行銷、產品經理", fitTask:"數位轉型、Ai協作導入、自動化、資料處理與報表、營運分析", fitGeneral:"成為團隊的科技/ AI大使，解決痛點",
  ...
  { id:58, category:"Skills & Application", title:"商業思維",
    ...
    shadow1:"過度功力，凡事只看錢", shadow2:"容易忽略文化與人的非財務因素",
  ...
  { id:59, category:"Skills & Application", title:"照顧他人",
    ...
    consequence2:"倦怠與角色混亂", adjustment2:"明確服務範圍、值班/輪班與轉借門檻",
    fitRole:"護理、長照、又叫、社工、專業服務工作者", fitTask:"客服或人員關懷", fitGeneral:"在高壓或危險環境下，安撫他人情緒與不安",
