...
const VALUE_CARDS = [
  ...
  { id: 27, text: '尊重傳統、延續歷史', category: '美德價值' },
  ...
  { id: 33, text: '歸屬與認同，屬於某個身分或團體', category: '人際關係' },
  ...
  { id: 43, text: '對他人或社會有影響力', category: '工作追求' },
  ...
  { id: 48, text: '權威身分，擁有特定地位與職權', category: '工作追求' },
  ...
  { id: 66, text: '安全感，工作上或心裡可預測、可掌控', category: '工作追求' },
