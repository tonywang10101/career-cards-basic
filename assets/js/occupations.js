...
const OCCUPATIONS = [
  ...
  { id:44, name:'總經理', field:'管理/財經學群', code:'ECS', skills:["顧客服務", "管理", "人力資源"], goals:["安排工作和活動時程", "指導與激勵部屬", "提出解決問題的方案"], desc:'指導公司運作，包含營運政策、日常管理、規劃財務及人力使用。' },
  ...
  { id:48, name:'網站行銷策劃', field:'管理/資訊/大眾傳播學群', code:'EIC', skills:["銷售行銷", "顧客服務", "傳播媒體"], goals:["運用電腦工作", "分析資訊", "持續進修專業知識"], desc:'研究搜尋引擎的收錄規則與使用者行為，增加網路曝光程度。' },
  { id:49, name:'企管顧問', field:'管理學群', code:'EIC', skills:["管理", "銷售行銷", "顧客服務"], goals:["建立夥伴關係", "提供諮詢", "提出解決問題的方案"], desc:'參與企業管理和決策過程，提出未來發展建議或現況改善方案。' },
