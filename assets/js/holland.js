...
const CARDS = [
  ...
  },
  {
    ...
    english: 'Artistic',
    chinese: '創造者',
    description: '創造者充滿創意與想像力，總是有很多新穎的想法，喜歡設計、戲劇、文學、舞蹈、音樂等活動，具有強大的直覺與靈感，對美的追求往往更勝於對科學的偏好。在生涯選擇上，喜歡待在充滿變化與挑戰的環境，讓自己的獨特性得以充分發揮。',
    strengths: ['運用想像力與創造力產生靈感', '做事創新、彈性而靈活', '喜愛設計與創造', '具有文藝天賦'],
    careers: ['藝術', '設計等領域']
  },
  {
    code: 'S',
  ...
  },
  {
    ...
    chinese: '影響者',
    description: '影響者自信果敢且充滿精力，勇於競爭與冒險，喜歡商業活動與決策。善用自己的資源和能力影響或說服別人，讓別人接受自己提出的想法或執行方式。適合當企業家，或在團隊中擔任並發起計畫的角色。在生涯選擇上，會追求經營地位較高的工作。',
  ...
  },
  {
    ...
    chinese: '組織者',
    description: '組織者喜歡有系統、講求效率的 SOP 工作方式，無法接受混亂、沒有秩序的環境，在乎事情的精確細節並一絲不苟。在生涯選擇上，偏好規則清楚且明確的環境，善於透過行政處理讓事情順利運轉。',
